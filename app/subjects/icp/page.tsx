...
import { Code, Filter, CheckCircle2, Clock, AlertCircle } from 'lucide-react';

type FilterType = 'all' | 'pending' | 'completed' | 'overdue';

export default function ICPSubjectPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Fetch user's submissions for ICP
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">ICP (Coding Problems)</h1>
              <p className="text-gray-600 mt-1">Practice coding problems with multiple languages</p>
            </div>
          </div>
        </div>
